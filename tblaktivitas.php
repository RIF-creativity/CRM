...
<body>
    <div class="container mt-4">
        <div class="row">
            <h1>Aktivitas <span class="p">jumlah</span></h1>
        </div>
    </div>
    <div class="container">
        <div class="row">
                ...
                <form class="form-inline">
                    <div class="form-group">
                        <select class="form-control" id="categoryFilter">
                            ...
                            <option value="belum-dibaca">Belum berjalan</option>
                            <option value="sistem">Berjalan</option>
                            <option value="feedback">Selesai</option>
                        </select>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><center>Tindak lanjut</center></th>
